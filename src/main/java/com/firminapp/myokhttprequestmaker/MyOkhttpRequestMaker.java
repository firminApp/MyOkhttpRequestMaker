...
public class MyOkhttpRequestMaker extends OkHttpClient  {
    ...
    private String TAG=MyOkhttpRequestMaker.class.getSimpleName();
     ...
     * @param postparam
     */
    public MyOkhttpRequestMaker(String url, JSONObject postparam)
    {
   ...
   // this.retryOnConnectionFailure();
    ...
    public MyOkhttpRequestMaker setContext(Context context){
        this.context=context;
        
        return  this;
    }
    public MyOkhttpRequestMaker setMultipart(String name, String filePath, String fileName, MediaType MEDIA_TYPE) {
    ...
    public MyOkhttpRequestMaker setMethod(MyMethods method)
    {
        this.method=method;
        return this;
    }
    public MyOkhttpRequestMaker setUrl(String urlo){
        this.urlbuilder=HttpUrl.parse(urlo).newBuilder();

        return  this;
    }

    public MyOkhttpRequestMaker setGet(Get get){
    ...
    public MyOkhttpRequestMaker setPost(Post post){
    ...
    public MyOkhttpRequestMaker addFormDataPart(FormDataPart fdp)
    {

        return this;
    }
    public MyOkhttpRequestMaker setFiles(File file, String idCorporate, String idFormJuridique){
    ...
    public MyOkhttpRequestMaker setGetListe(ArrayList<Get>listgets){
    ...
    public MyOkhttpRequestMaker setPostList(ArrayList<Post>listpost){
    ...
    public MyOkhttpRequestMaker setFileList(ArrayList<Post>listpost,ArrayList<File>listefile){
        for (Post post:listpost)
        {
            setPost(post);
        }
    ...
    public MyOkhttpRequestMaker setHeader(Header header){
    ...
    public MyOkhttpRequestMaker setHeaderList(ArrayList <Header> headerListe){
     ...
     * @return
     */
    public MyOkhttpRequestMaker onJsonObjectReceved(final OnJsonObjectResponseListener objectlistebner){
...
//                            Log.e("cachbody after",response.body().string());
     ...
     */
    public MyOkhttpRequestMaker onJsonArrayReceved(final OnJsonArrayResponseListener marraylistener){
...
//                    Log.e(TAG,local);
    ...
    public MyOkhttpRequestMaker onResponse(final OnResponseListener responseListener){
     ...
     * @return
     */
    public MyOkhttpRequestMaker onFailled(final OnFalledListener onFailledListener){
   ...
   //  * @param cachFileName Le nom du fichier dans lequel ecrire du cache.
    ...
    public MyOkhttpRequestMaker onCheckServerStatut(String serverIp,final OnserverStatutListener responseListener) {
